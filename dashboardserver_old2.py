    ...
    if user:
        ...
        try:
            ...
            if conn:
                ...
                cursor.close()
                conn.close()
                # Add last_login to user session
...
def restaurant_detail(restaurant_id):
    ...
    print(f"🔍 Route: /restaurant/{restaurant_id}")
...
# ============================================================================
# ADMIN API ENDPOINTS - Add these to your dashboardserver.py
# ============================================================================
# Copy and paste these routes into your dashboardserver.py file
# They should go after your existing routes but before the error handlers
...
def api_create_user():
    ...
    try:
        ...
        if user_id:
            ...
            return jsonify({'success': False, 'error': 'User already exists or creation failed'}), 400
    ...
    try:
        ...
        if password:
            ...
            cursor.execute("""
                ...
                WHERE id = %s
            """, (full_name, email, role, password_hash, user_id))
        else:
            cursor.execute("""
                UPDATE dashboard_users 
...
# -----------------------------------------------------------------------------
# CDN FALLBACK (for Cloudflare email protection scripts)
# -----------------------------------------------------------------------------
